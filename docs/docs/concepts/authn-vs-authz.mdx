...
Please check out [App-specific branding](../recipes/customize-sie/match-your-brand/#app-specific-branding) and [Organization-specific logos](../recipes/customize-sie/match-your-brand/#organization-specific-logos) for relative configurations.
